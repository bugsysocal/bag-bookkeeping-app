...
**Project:** LedgerOne (placeholder) · **Covers:** Planning doc §4.3, §4.4, §11 items 4–5 · **Status:** APPROVED v1.0 (2026-07-03; #7 amended: write-off threshold **and** routing accounts are company-level settings; #2–5, #8–9 approved via scope audit — none touch VAT/WHT posting or the balance guarantee)
...
*End of Spec 04. Next per §11 order: Spec 05/06 — Statements & reports (planning doc numbering merges §11 item 6).*
